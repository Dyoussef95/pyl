window.onload = function() {
    var elem = document.getElementById('asistidos');
    elem.style.borderLeft = "4px solid #3498db";
    $(elem).parent().toggleClass('active2');
};

/*BUSCADOR TABLA W3SCHOOLS*/
function search() {
    // Declare variables
    var input, filter, table, tr, td, i, txtValue, cant=0;
    ...
    document.getElementById("cant").innerHTML ="&nbsp"+cant;
  }
/*
...
/*ORDENAR TABLA CLICKEANDO ICONO COLUMNA W3SCHOOLS*/
